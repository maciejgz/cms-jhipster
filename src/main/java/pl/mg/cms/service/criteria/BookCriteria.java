package pl.mg.cms.service.criteria;
...
/**
 * Criteria class for the {@link pl.mg.cms.domain.Book} entity. This class is used
 * in {@link pl.mg.cms.web.rest.BookResource} to receive all the possible filtering options from
...
public class BookCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, releaseDate, distinct);
    }
